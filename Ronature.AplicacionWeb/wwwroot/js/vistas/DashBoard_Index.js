    ...
    fetch("/DashBoard/ObtenerResumen")
        ...
        .then(responseJson => {
            ...
            if (responseJson.estado) {
                ...
                //Información de Grafico de Barras
                let barchart_labels;
                let barchart_data;
                ...
                //Información de Grafico de Pie
                let piechart_labels;
                let piechart_data;

                if (d.productosTopUltimaSemana.length > 0) {
                    piechart_labels = d.productosTopUltimaSemana.map((item) => { return item.txtProducto })
                ...
                let myBarChart = new Chart(controlVenta, {
                    type: 'bar',
                    data: {
                        labels: barchart_labels, //labels generadas
                        datasets: [{
                            label: "Cantidad",
                            backgroundColor: "#4e73df",
                            hoverBackgroundColor: "#2e59d9",
                            borderColor: "#4e73df",
                            data: barchart_data, //data generada
                        }],
                    },
                    options: {
                ...
                let myPieChart = new Chart(controlProducto, {
                    type: 'doughnut',
                    data: {
                        labels: piechart_labels,//labels generadas
                        datasets: [{
                            data: piechart_data,//data generada
